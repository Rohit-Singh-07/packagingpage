...
function NewComponent({ onSave }) {
  ...
  return (
    <>
      <div className="bg-zinc-50 border-2 border-zinc-200 rounded-lg md:w-[56vw] w-[90vw] transition-all mb-6">
        ...
        <h2 className="text-[23px] font-medium pb-4">New Components</h2>
          ...
          <div className="flex flex-col gap-4 md:w-[80%] w-[100%]">
            ...
            <div className="flex md:flex-row flex-col md:gap-12 gap-4 text-[20px] text-zinc-500 font-medium">
